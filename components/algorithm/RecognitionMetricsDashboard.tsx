    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className="timer-card">
          ...
          <div className="text-xs text-[var(--text-muted)] mt-1">Fastest</div>
        </div>
        ...
        <div className="timer-card">
          ...
          <div className="text-xs text-[var(--text-muted)] mt-1">Slowest</div>
        </div>
        ...
        <div className="timer-card">
          ...
          <div className="text-xs text-[var(--text-muted)] mt-1">Mastered</div>
          <div className="text-xs text-[var(--text-muted)] mt-1">
        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-sm font-mono text-[var(--text-primary)] font-statement">
                {formatTime(metrics.averageRecognitionTime)}
              </span>
            </div>
          ...
          <div className="pt-2 border-t border-[var(--border)]">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-mono font-bold text-[var(--primary)] font-statement">
                {formatTime(
      ...
      <div className="timer-card bg-[var(--primary)]/5 border border-[var(--primary)]/20">
        <h3 className="text-lg font-bold text-[var(--text-primary)] font-statement mb-3">
          💡 Improvement Tips
        </h3>
