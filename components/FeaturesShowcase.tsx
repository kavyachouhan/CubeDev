          ...
          <div className="space-y-6">
            <div className="bg-(--surface-elevated) p-4 sm:p-6 rounded-lg border border-(--border)">
              ...
              <div className="text-center space-y-4">
                <div className="text-6xl font-bold text-(--primary) font-mono animate-pulse">
                  12.43
                </div>
            ...
            <div className="bg-(--surface-elevated) p-4 sm:p-6 rounded-lg border border-(--border)">
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  >
                    <span className="text-xs text-(--text-secondary) font-inter w-12">
                      {item.phase}
                    </span>
                    ...
                    <span className="text-xs text-(--text-primary) font-mono w-10 text-right">
                      {item.time}
                    </span>
                  </div>
                ))}
          ...
          <div className="space-y-6">
            <div className="bg-(--surface-elevated) p-4 sm:p-6 rounded-lg border border-(--border)">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-(--success) font-button px-2 py-1 bg-(--success)/10 rounded">
                  Active
                </span>
              </div>
              ...
              <div className="space-y-3 mb-4">
                <div className="text-sm font-semibold text-(--text-primary) font-button flex items-center gap-2">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-medium text-(--text-muted) font-inter w-8">
                        {item.day}
                      </span>
                      <span
          ...
          <div className="space-y-6">
            <div className="bg-(--surface-elevated) p-4 sm:p-6 rounded-lg border border-(--border)">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-(--primary) font-button px-2 py-1 bg-(--primary)/10 rounded">
                  SRS Active
                </span>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-(--surface-elevated) p-4 sm:p-6 rounded-lg border border-(--border)">
              ...
              <div className="text-center p-4 bg-(--background) rounded-lg mb-4">
                ...
                <div className="text-sm text-(--text-secondary) font-inter mt-1">
                  Ao5 Round
                </div>
              </div>
    ...
    <section className="py-16 lg:py-24 bg-(--background)">
      <div className="container-responsive">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-bold text-(--text-primary) mb-4 font-statement">
            Everything You <span className="text-(--primary)">Need</span>{" "}
            To Improve
          </h2>
          <p className="text-lg md:text-2xl text-(--text-secondary) max-w-3xl mx-auto font-inter">
            ...
            >
              ...
              {index % 2 === 0 ? (
                <>
                  ...
                  <div className="space-y-6">
                    <div className="mb-4">
                      <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-(--text-primary) font-statement">
                        {feature.title}
                      </h3>
                    </div>
