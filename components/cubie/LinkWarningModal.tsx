    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl max-w-md w-full shadow-lg">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="p-3 bg-[var(--surface-elevated)] border border-[var(--border)] rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-semibold text-[var(--text-muted)] font-inter">
                Destination:
              </span>
            </div>
            <p className="text-sm text-[var(--text-primary)] font-inter break-all">
              {getDomain(url)}
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="text-xs text-[var(--text-secondary)] font-inter space-y-1 pl-4 list-disc">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 p-4 border-t border-[var(--border)] bg-[var(--surface-elevated)]">
          <button
            onClick={onClose}
            className="w-full sm:flex-1 px-4 py-2.5 sm:py-2 bg-[var(--surface)] hover:bg-[var(--surface-elevated)] border border-[var(--border)] text-[var(--text-primary)] rounded-lg transition-colors font-button text-sm"
          >
            Cancel
          </button>
          <button
            onClick={onProceed}
            className="w-full sm:flex-1 px-4 py-2.5 sm:py-2 bg-[var(--primary)] hover:bg-[var(--primary)]/90 text-white rounded-lg transition-colors font-button text-sm"
          >
            Continue to Link
          </button>
        </div>
