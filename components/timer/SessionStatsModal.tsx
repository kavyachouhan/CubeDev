        ...
        <div className="p-4 border-t border-[var(--border)] bg-[var(--surface)] flex flex-col sm:flex-row gap-2">
          ...
          <div className="relative flex-1" ref={shareMenuRef}>
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white rounded font-medium transition-colors"
            >
            ...
            {shareMenuOpen && (
              <>
                      ...
                      <div className="flex justify-center gap-4 pt-2 pb-4">
                        {SHARE_OPTIONS.map((option) => (
                          ...
                          >
                            ...
                            <span className="text-[10px] text-[var(--text-muted)]">{option.name}</span>
                          </button>
                        ))}
                      </div>
                    </div>
                ...
                <div className="hidden sm:block absolute bottom-full mb-2 left-0 w-64 bg-[var(--surface)] border border-[var(--border)] rounded-xl shadow-lg z-[100] overflow-hidden">
