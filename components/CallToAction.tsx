...
export default function CallToAction() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-24 bg-(--surface) relative overflow-hidden border-t border-(--border)"
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="w-4 h-4 bg-(--primary)/20 rounded-full absolute top-20 left-20"></div>
          <div className="w-2 h-2 bg-(--primary)/10 rounded-full absolute top-40 right-32"></div>
          <div className="w-3 h-3 bg-(--primary)/15 rounded-full absolute bottom-32 left-1/3"></div>
          <div className="w-2 h-2 bg-(--primary)/10 rounded-full absolute bottom-20 right-20"></div>
        </div>
      </div>
        ...
        >
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-(--text-primary) mb-6 font-statement">
              Ready to <span className="text-(--primary)">master</span>{" "}
              your next solve?
            </h2>
            <p className="text-xl md:text-2xl text-(--text-secondary) mb-8 font-inter leading-relaxed">
