...
export default function ProfileShareMenu({
  ...
  const shareUrl = `https://cubedev.xyz/cuber/${wcaId}`;
  const shareText = `Check out ${person.name}'s cubing profile on CubeDev!`;
    ...
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <>
          ...
          <div className="hidden sm:block absolute top-full mt-2 left-1/2 -translate-x-1/2 w-64 bg-[var(--surface)] border border-[var(--border)] rounded-xl shadow-lg z-[100] overflow-hidden">
