  ...
  return (
    <>
                ...
                {option.icon && (
                  <div
                    className={`flex-shrink-0 ${
                      option.variant === "danger"
                        ? ""
                        : "p-2 bg-[var(--surface-elevated)] border border-[var(--border)] rounded-lg"
                    }`}
                  >
                    {option.icon}
                  </div>
      ...
      <div className="hidden sm:block" ref={menuRef}>
        ...
        <div
          className="absolute left-1/2 -translate-x-1/2 top-full mt-1 bg-[var(--surface)] border border-[var(--border)] rounded-lg shadow-xl z-50 py-1 overflow-hidden"
