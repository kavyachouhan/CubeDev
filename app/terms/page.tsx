          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="text-foreground leading-relaxed mb-4">
                By accessing and using CubeDev, you accept and agree to be bound
            ...
            <section>
              ...
              <ul className="space-y-2 text-foreground ml-4">
                <li>
                  You must have a valid World Cube Association (WCA) account to
                  use CubeDev
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed mb-4">
                You agree to use CubeDev only for lawful purposes. You may not:
              </p>
              <ul className="space-y-2 text-foreground ml-4">
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed mb-4">
                You retain ownership of all solve times, comments, and data you
                submit to CubeDev. By submitting content, you grant us
                permission to store and display this data as part of our
                service.
              </p>
              <p className="text-foreground leading-relaxed mb-4">
                CubeDev is built on trust within the speedcubing community.
                Submitting false times, using solve assistance, or any form of
                cheating undermines the platform for everyone. Violations may
            ...
            <section>
              ...
              <ul className="space-y-2 text-foreground ml-4">
                ...
                <li>
                  We recommend regular data exports as an additional precaution
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed mb-4">
                ...
                agree to our Privacy Policy, which explains how we collect, use,
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed mb-4">
                CubeDev is provided "as is" without warranties of any kind. To
              ...
              <ul className="space-y-2 text-foreground ml-4">
                ...
                <li>
                  We are not liable for platform downtime or technical issues
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed">
                <strong>We may:</strong> Suspend accounts for terms violations
                or terminate service with reasonable notice.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-foreground leading-relaxed">
                ...
                parts will continue in full effect.
              </p>
            </section>
