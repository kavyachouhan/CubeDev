...
export const metadata: Metadata = {
    ...
    keywords: ['speedcubing', 'rubiks cube', 'algorithms', 'virtual cube', 'cube simulator', 'practice', "cube lab", "cubedev", "cube timer", "cube statistics", "cube training", "cubie ai", "cube challenges", "cube analysis", "cubing tools", "speedcubing resources"],
    openGraph: {
        title: 'Cube Lab | CubeDev',
        description: 'Explore various tools and features in Cube Lab to enhance your speedcubing experience. Try out our timer, statistics, and more.',
